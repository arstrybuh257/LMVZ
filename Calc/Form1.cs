...
namespace Calc
{
    public partial class Form1 :MetroFramework.Forms.MetroForm
    {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            if (ok)
            {
                Form2 f = new Form2(metroTextBox1.Text, metroComboBox1.SelectedItem.ToString(), Convert.ToInt32(metroTextBox2.Text), Convert.ToDouble(metroTextBox3.Text), Convert.ToDouble(metroTextBox4.Text), x);
                f.Show();
                Hide();
            }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            t.SetToolTip(metroTextBox1, "Как к вам обращаться?");
            ToolTip t2 = new ToolTip();
            t2.SetToolTip(metroTextBox2, "Сколько вам лет?");
            t2.SetToolTip(metroLabel2, "Сколько вам лет?");
            ToolTip t3 = new ToolTip();
            t3.SetToolTip(metroTextBox3, "Сколько вы сейчас весите(килограмм)?");
            t3.SetToolTip(metroLabel3, "Сколько вы сейчас весите(килограмм)?");
            ToolTip t4 = new ToolTip();
            t4.SetToolTip(metroTextBox4, "Ваш рост на данный момент(сантиметров)");
            t4.SetToolTip(metroLabel4, "Ваш рост на данный момент(сантиметров)");
